  ...
  function buildNav(active){
    ...
    if(cc==='all'){
      navEl.innerHTML =
        ...
        '<div class="nav-label">Phase 1 · Inquiry '+bpBadge+'</div>'+
        navLink('inquiry','Inquiry log','dash-inquiry.html',active==='inquiry')+
        '<div class="nav-label">Phase 2–3 · Collect '+bpBadge+'</div>'+
        ...
        '<div class="nav-label">Phase 4–5 · Verify '+bpBadge+'</div>'+
        ...
        '<div class="nav-label">Phase 6 · Disclose '+bpBadge+'</div>'+

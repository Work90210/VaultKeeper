...
(function(){
  var ICONS = {
    ...
    assess: '<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M2 13h12M4 9h2v4H4zM7 6h2v7H7zM10 3h2v10h-2z"/></svg>',
  ...
  function buildNav(active){
    ...
    // Berkeley Protocol badge
    var bpBadge = '<span style="font-size:8px;padding:1.5px 5px;border-radius:3px;background:rgba(184,66,28,.06);border:1px solid rgba(184,66,28,.12);letter-spacing:.05em;color:var(--accent);vertical-align:1px;margin-left:2px">BP</span>';
    ...
    if(cc==='all'){
      navEl.innerHTML =
        ...
        navLink('inquiry','1 · Inquiry log','dash-inquiry.html',active==='inquiry')+
        navLink('assess','2 · Assessments','dash-assessments.html',active==='assess','412')+
        navLink('evidence','3 · Evidence','dash-evidence.html',active==='evidence','14.2k')+
        navLink('witnesses','3 · Witnesses','dash-witnesses.html',active==='witnesses')+
        navLink('audit','4 · Audit log','dash-audit.html',active==='audit')+
        navLink('corrob','5 · Corroborations','dash-corroborations.html',active==='corrob','7')+
        navLink('analysis','6 · Analysis notes','dash-analysis.html',active==='analysis')+
      ...
      navEl.innerHTML =
        ...
        '<div class="nav-label">Investigation</div>'+
        navLink('inquiry','1 · Inquiry log','dash-inquiry.html',active==='inquiry')+
        navLink('assess','2 · Assessments','dash-assessments.html',active==='assess')+
        navLink('evidence','3 · Evidence','dash-evidence.html',active==='evidence',c.exhibits)+
        navLink('witnesses','3 · Witnesses','dash-witnesses.html',active==='witnesses',String(c.witnesses))+
        navLink('audit','4 · Audit log','dash-audit.html',active==='audit')+
        navLink('corrob','5 · Corroborations','dash-corroborations.html',active==='corrob',String(c.corrob))+
        navLink('analysis','6 · Analysis notes','dash-analysis.html',active==='analysis')+
        '<div class="nav-label">Reporting</div>'+
        navLink('redact','Redaction','dash-redaction.html',active==='redact','live',true)+
